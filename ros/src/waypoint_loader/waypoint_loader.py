...
class WaypointLoader(object):
    ...
    def __init__(self):
        ...
        self.velocity = self.kmph2mps(rospy.get_param('~velocity')) # this is defined in /launch/waypoint_loader.launch
        rospy.logwarn("waypoint loader will load at velocity = {}".format(str(self.velocity)))
