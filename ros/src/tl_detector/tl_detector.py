...
class TLDetector(object):
    ...
    def image_cb(self, msg):
        ...
        if self.state != state:
            ...
            # only publish if we've detected the same light color for awhile to reduce noise
    ...
    def process_traffic_lights(self):
        ...
        line_wp_idx = None  # index of closest waypoint to the stopline
        ...
        if(self.pose):
            ...
            diff = len(self.waypoint.waypoints)  # calculate the diff in terms of waypoint indexes
